 ...
 */
final class Version20240302142648 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse_location ADD CONSTRAINT FK_11206BCFE6148B FOREIGN KEY (reponse_location_id) REFERENCES location (id) ON UPDATE CASCADE ON DELETE CASCADE');
